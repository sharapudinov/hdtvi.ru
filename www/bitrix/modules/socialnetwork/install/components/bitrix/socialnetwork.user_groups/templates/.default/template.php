...
else
{
	...
	)
	{
		...
		?><span class="sonet-groups-search"><?$APPLICATION->IncludeComponent(
	...
	?><div class="sonet-groups-content-wrap<?=(!$notEmptyList ? " no-groups" : "")?>">
		<div class="sonet-groups-content-sort-container" id="bx-sonet-groups-sort">
			<?=GetMessage('SONET_C33_T_F_SORT')?><span class="sonet-groups-content-sort-btn" id="bx-sonet-groups-sort-value"><?=GetMessage('SONET_C33_T_F_SORT_'.strtoupper($arResult["ORDER_KEY"]))?></span>
		</div>
		<?
