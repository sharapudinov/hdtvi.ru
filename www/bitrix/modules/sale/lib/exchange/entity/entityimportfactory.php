...
class EntityImportFactory
{
     ...
     * @return OrderImport|PaymentCardImport|PaymentCashImport|PaymentCashLessImport|Exchange\ProfileImport|ShipmentImport
    ...
    public static function create($entityTypeID, $parentEntityContext = null)
    {
        ...
        elseif($entityTypeID === Exchange\EntityType::PROFILE)
        {
            return new Exchange\ProfileImport();
        }
        else
        {
